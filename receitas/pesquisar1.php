...
<div class="container d-flex w-100 h-100 p-3 mx-auto flex-column">
    ...
    <form method="POST" id="form-pesquisa" action="">
        ...
        <input class="form-control" type="text" name="pesquisa" id="pesquisa" placeholder="Digite alguma palavra sobre a receita:">
    </form>
    <table class="resultado table-striped table-hover table-sm">
    </table>
<br>
    ...
    <div id="myModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content text-dark">
                ...
                <div class="modal-body visualizar">
