...
$id = $_GET['id'];
//$id = filter_input(INPUT_POST, 'palavra', FILTER_SANITIZE_STRING);
//Pesquisar no banco de dados nome do usuario referente a palavra digitada
$result_user = "SELECT * FROM receitas WHERE id = $id";
...
?>
      <h1><?php echo $row_user['titulo'];?></h1>
        <h5>INGREDIENTES</h5>
       <p><?php echo $row_user['ingredientes'];?></p>
       <h5>MODO DE FAZER</h5>
        <p><?php echo $row_user['fazer'];?></p>
        <p>ELABORADA POR: <?php echo $row_user['autor'];?></p>
        <p> <a href="pesquisar.php" class="btn btn-dark btn-sm" role="button">Voltar</a></p>
